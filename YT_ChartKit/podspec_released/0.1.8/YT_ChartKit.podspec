...
分时K线图表库
  ...
  s.subspec 'YTKLineChart' do |k|
    ...
    k.subspec 'Calculator' do |c|
      ...
      c.subspec 'IndexCalculator' do |index|
            index.source_files = 'YT_ChartKit/Classes/YTKLineChart/Calculator/IndexCalculator/**/*'
      end
    end
  ...
  s.subspec 'YTTimeChart' do |t|
    ...
    t.subspec 'ChartView' do |view|
      view.source_files = 'YT_ChartKit/Classes/YTTimeChart/ChartView/**/*'
    end
